...
from Model.MultiLSTMClassifier import MultiLSTMClassifier
...
def evaluate(model, dataloader, device):
    ...
    # Calculate multi-label exact match accuracy
...
def main():
    ...
    train_path = '/root/autodl-tmp/MovieLabeling/datasets/train_data.csv'
    train_dataset = RobertaTextDataset(csv_file=train_path, device='cuda')
    
    test_path = '/root/autodl-tmp/MovieLabeling/datasets/test_data.csv'
    test_dataset = RobertaTextDataset(csv_file=test_path, device='cuda')
